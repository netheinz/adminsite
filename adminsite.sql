...
# Database: adminsite
# Generation Time: 2018-02-14 04:59:18 +0000
# ************************************************************
...
CREATE TABLE `org` (
	...
	CONSTRAINT `org_ibfk_1` FOREIGN KEY (`country_id`) REFERENCES `country` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `user` (
	...
	`address` varchar(255) NOT NULL DEFAULT '' COMMENT 'Adresse',
	`city_id` int(11) NOT NULL COMMENT 'Postnummer',
	`country_id` int(11) NOT NULL,
	...
	`birthdate` bigint(20) NOT NULL DEFAULT '0' COMMENT 'Organisation',
	...
	CONSTRAINT `user_ibfk_3` FOREIGN KEY (`city_id`) REFERENCES `city` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `user` WRITE;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;

INSERT INTO `user` (`id`, `username`, `password`, `firstname`, `lastname`, `address`, `city_id`, `country_id`, `org_id`, `email`, `phone1`, `phone2`, `phone3`, `birthdate`, `gender`, `created`, `suspended`, `deleted`)
VALUES
	(1,'admin','$2y$10$eD0PuOqt0SabZvvlNk0iNebKy7MxZ0q0pSIN7etmP5H.ZRlXZus3q','Admin','Amin Admin','Admingade 12',9520,56,3,'admin@admin.dk',NULL,NULL,NULL,1517559355,'m',1517559355,0,0);
...
CREATE TABLE `usergrouprel` (
	...
	CONSTRAINT `usergrouprel_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
	CONSTRAINT `usergrouprel_ibfk_2` FOREIGN KEY (`group_id`) REFERENCES `usergroup` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
